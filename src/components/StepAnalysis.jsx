              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  ...
                  <div className="space-y-4">
                    {[
                      { num: '1', text: 'We produce your live stream (1-2 pro cameras, full setup)' },
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {getPackages(analysis.tier).map((pkg, index) => (
              <div
                key={pkg.name}
                className={`bg-dark-800 border-2 rounded-xl p-6 sm:p-8 flex flex-col ${
                  pkg.popular ? 'border-primary-600 relative card-glow' : 'border-gray-700'
                }`}
              >
                {pkg.popular && (
                ...
                <div className={`mb-6 ${pkg.popular ? 'mt-2' : ''}`}>
